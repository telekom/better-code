...
/// <summary>
/// Deterministic seed data (12 items, 5 brands, 4 types). Used by EF Core HasData
/// and by the in-memory CatalogServiceMock. Preserved from legacy PreconfiguredData.
/// </summary>
public static class PreconfiguredData
{
    public static List<CatalogItem> GetPreconfiguredCatalogItems() => new()
    {
